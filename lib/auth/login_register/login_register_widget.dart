...
import '/auth/forgot_password/forgot_password_widget.dart';
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'dhq06fw3' /* Para começar preencha os campo... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.start,
                                                        style:
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'LOGIN_REGISTER_PAGE_CRIAR_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_auth');
                                                            GoRouter.of(context)
                                                                .prepareAuthEvent();
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'qmi3xov6' /* Preencha as informações para a... */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'LOGIN_REGISTER_PAGE_ENTRAR_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_auth');
                                                            GoRouter.of(context)
                                                                .prepareAuthEvent();
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'LOGIN_REGISTER_CONTINUAR_COM_GOOGLE_BTN_');
                                                                  logFirebaseEvent(
                                                                      'Button_auth');
                                                                  GoRouter.of(
                                                                          context)
                                                        ...
                                                        builder: (context) =>
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'LOGIN_REGISTER_ESQUECEU_A_SENHA__BTN_ON_');
                                                              logFirebaseEvent(
                                                                  'Button_alert_dialog');
                                                              await showDialog(
                                                                context:
