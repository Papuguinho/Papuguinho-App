...
class BoardTempoWidget extends StatefulWidget {
  ...
  static String routeName = 'boardTempo';
  static String routePath = '/boardTempo';
...
class _BoardTempoWidgetState extends State<BoardTempoWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'boardTempo'});
                ...
                Expanded(
                  child: wrapWithModel(
                    ...
                    child: BoardPictogramasWidget(
                      listaPictogramas: FFAppState().listaBoardTempo,
                    ),
                  ),
                ),
                wrapWithModel(
