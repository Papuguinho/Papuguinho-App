...
class _QuimicaPraticaWidgetState extends State<QuimicaPraticaWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'QUIMICA_PRATICA'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('QUIMICA_PRATICA_arrow_back_rounded_ICN_O');
                          ...
                          child: ListView(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'QUIMICA_PRATICA_PAGE_QUIMICA_ON_TAP');
                                  logFirebaseEvent('QUIMICA_navigate_to');

                                  context
                                      .pushNamed(MedicamentosWidget.routeName);
