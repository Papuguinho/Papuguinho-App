...
class _TQuimicaWidgetState extends State<TQuimicaWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'T_QUIMICA'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('T_QUIMICA_arrow_back_rounded_ICN_ON_TAP');
...
ORGÂNICA */
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'T_QUIMICA_PAGE_MATEMATICA_ON_TAP');
                                  logFirebaseEvent('MATEMATICA_navigate_to');

                                  context.pushNamed(
                                      QuimicaPraticaWidget.routeName);

                                  logFirebaseEvent(
                                      'MATEMATICA_update_app_state');
                                  FFAppState().palavraTemas = 'Química prática';
                                  safeSetState(() {});
                                  logFirebaseEvent('MATEMATICA_custom_action');
                                  await actions.speakText(
                                    FFAppState().palavraTemas,
                                  );
                                  logFirebaseEvent(
