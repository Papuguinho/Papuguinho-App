                                            ...
                                            children: [
                                              Align(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'HISTORY_PAGE_Icon_xyqs8ek0_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Icon_navigate_back');
                                                    context.safePop();
                                                    logFirebaseEvent(
                                              ...
                                              Align(
                                                ...
                                                child: Builder(
                                                  builder: (context) => InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'HISTORY_PAGE_Icon_1he7b60u_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Icon_alert_dialog');
                                                      await showDialog(
                                                        context: context,
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'vp5a1oo9' /* Histórico de mensagens */,
                                              ),
                                                ...
                                                Align(
                                                  ...
                                                  child: Builder(
                                                    builder: (context) =>
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'HISTORY_PAGE_calendar_month_ICN_ON_TAP');
                                                        logFirebaseEvent(
                                                ...
                                                Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'HISTORY_PAGE_Stack_z5gwaojq_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Stack_alert_dialog');
