...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.dateOfBirthTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.birth, ''));
    ...
    _model.fullNameTextController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.schoolLevel, ''));
    _model.fullNameFocusNode2 ??= FocusNode();
    _model.fullNameFocusNode2!.addListener(() => safeSetState(() {}));
    _model.descriptionTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.motivationToUsE, ''));
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'EDIT_PROFILE_COMP_Icon_je43mu4h_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_alert_dialog');
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: Text(
                                                                'Descartar mudanças'),
                                                            content: Text(
                                                                'Deseja parar de editar seu perfil e descartar as mudanças?'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'r6v660ng' /* Por favor, nos ajude com essas... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      builder: (context) =>
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EDIT_PROFILE_CircleImage_lpgjmfgp_ON_TAP');
                                                          logFirebaseEvent(
                                            ...
                                            builder: (context) => TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'ccpvipy4' /* Motivo de usar o aplicativo */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyLarge
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'EDIT_PROFILE_COMP_SALVAR_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_backend_call');
